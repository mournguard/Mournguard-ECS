...
const EntityInspectorPlugin = preload("res://addons/ECS/Entity/entity_inspector.gd")
var entity_inspector_plugin: EditorInspectorPlugin
const ComponentInspectorPlugin = preload("res://addons/ECS/Component/component_inspector.gd")
